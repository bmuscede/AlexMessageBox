...
public class GifFixer {
    ...
    public GifFixer() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                // Ask the user for where we want to save.
                String orig = "", mirror = "";
                try {
                System.out.print("Enter original GIF: ");
                orig = reader.readLine();
                System.out.print("Enter new save GIF: ");
                ...
                JFrame frame = new JFrame("GIF Changer");
                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                frame.setLayout(new BorderLayout());
                frame.add(new TestPane(orig, mirror));
                frame.pack();
    ...
    public class TestPane extends JPanel {
		private static final long serialVersionUID = -7470464125359257568L;
		private ImageIcon orig;
        private ImageIcon mirror;

        public TestPane(String origStr, String mirrorStr) {
            mirror(new File(origStr), 
            		new File(mirrorStr));
            orig = new ImageIcon(origStr);
            mirror = new ImageIcon(mirrorStr);
        }
